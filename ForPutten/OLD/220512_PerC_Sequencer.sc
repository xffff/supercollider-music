...
~sequencer = Pseq([
	...
	Ptpar([0,	Pfuncn({"Section 1".postln; 1 }, 1),
		0,Pdef(\section1_drum1), 
		0, Pdef(\section1_fx1),
		0, Pdef(\section1_sy1)],1),
	Ptpar([0,	Pfuncn({"Section 2".postln; 0 }, 1),
		0, Pdef(\section2_drum1),
		0.02, Pdef(\section2_fx1),
		0.02, Pdef(\section2_fx2), 
		0.02, Pdef(\section2_fx3)],1), 
	Ptpar([1,	Pfuncn({"Section 3".postln; 0 }, 1),
		1, Pdef(\section3_drum1), 
		1.02, Pdef(\section3_drum2), 
		1.02, Pdef(\section3_drum3), 
		1.02, Pdef(\section3_fx1),
		1.02, Pdef(\section3_fx2),
		1.02, Pdef(\section3_sy1)],1),  
	Ptpar([2,	Pfuncn({"Section 4".postln; 0 }, 1),
		2,Pdef(\section4_drum1),
		2,Pdef(\section4_fx1)],1),
	Ppar([Pfuncn({"Section 5".postln; 0 }, 1),
		Pdef(\section5_drum1),
		Pdef(\section5_fx1),
		Pdef(\section5_fx2),
		Pdef(\section5_fx3)],1),
	Ppar([Pfuncn({"Section 6".postln; 0}, 1),
		Pdef(\section6_drum1)], 1),
	Ptpar([0,Pfuncn({"Section 7".postln; 0 }, 1),
		0,Pdef(\section7_drum1),
		0,Pdef(\section7_drum2),
		0.02,Pdef(\section7_sy1),
		0.02,Pdef(\section7_fx1),
		0.02,Pdef(\section7_fx2),
		//0.02,Pdef(\section7_fx3),
		//0.02,Pdef(\section7_fx4)
		],1),
	Ppar([Pfuncn({"Section 8".postln; 0 }, 1),
		Pdef(\section8_drum1),
		Pdef(\section8_fx1),
		Pdef(\section8_fx2)
		],1),
